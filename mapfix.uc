...
event BeginPlay()
{
 ...
 function timer()
  {
     ...
     if  (lastversion < thisversion)
      ...
      csejte();
      log ("mapfixes is doing somthing!",'mapfixes');
  ...
  function normaltail()
 {
    ...
    local mover mvr;                 // movers
      ...
      {// fan fix.
      actNewClass = class<actor>( DynamicLoadObject("copyit.digfix", class'Class' ) );
      actaPawn=Spawn(actNewClass,,,vect(7653.117676,3551.962891,-372.099548));  // Fan
      actaPawn=Spawn(actNewClass,,,vect(7507.117676,3545.962891,-372.099548));  // Fan
      Log("  -  Spawning fan teleporter...",'mapfix');
      // tested ok!
      };
      ...
      Log("  -  Spawned The Lava Fix. ",'Mapfixes');
      // tested ok!
      }
      ...
      actaPawn=Spawn(actNewClass,,,vect(6013.467285,-2051.453613,-2006.893311)); // lava below glider
      ...
      actaPawn=Spawn(actNewClass,,,vect(7.431558,-16.399410,-5072.676758));    // space!
      ...
      { //  mover16   // tag sdd  stayopentime 999
       foreach AllActors(class'mover', mvr)
       {
        ...
        mvr.stayopentime = 90000;
        //mvr.trigger(self,self.Instigator);
        }

         // mabye spawn a teleporter inside?
       }
      ...
      // Titans
       ...
       if (  actthing != None ){Log("  -  Spawned titan 1..."$ string(actthing.name),'mapfix');};
       ...
       if (  actthing != None ){Log("  -  Spawned titan 2..."$ string(actthing.name),'mapfix');};
       ...
       if (  actthing != None ){Log("  -  Spawned titan 3..."$ string(actthing.name),'mapfix');};
